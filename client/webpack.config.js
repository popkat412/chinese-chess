...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      __DEPLOY_URL__: JSON.stringify(nodeEnv == "production" ? "https://yunze.wang" : "http://localhost:8080"),
      __SERVER_URL__: JSON.stringify(nodeEnv == "production" ? "https://yunze.wang" : "http://localhost:3000"),
    }),
  ],
  performance: {
    hints: false,
